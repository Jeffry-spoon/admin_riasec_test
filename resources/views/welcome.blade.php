    ...
    <div class="position-relative iq-banner">
        ...
        <div class="iq-navbar-header" style="height: 215px">
            ...
            <div class="iq-header-img">
                <img
                    src="{{ asset('images/dashboard/top-header.png') }}"
                    alt="header"
                        ...
                        >
                            ...
                            >
                                <div class="header-title">
                                    ...
                                    <p class="mb-0">
                                        <svg
                                            class="me-1 text-primary icon-24"
                                            width="24"
                                            viewBox="0 0 24 24"
                                            fill="none"
                                        ...
                                        {{ $countResults }} participant this
                                        week ({{ $formattedStartOfWeek }} -
                                        {{ $formattedEndOfWeek }})
                                    </p>
                                </div>
                            </div>
            ...
            <div class="col-md-12 col-lg-4">
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        >
                            <div
                                class="text-center card-body d-flex justify-content-around"
                            >
                                <div>
           ...
           <div class="col-md-12 col-lg-12">
              <div class="overflow-hidden card" data-aos="fade-up" data-aos-delay="600">
                 <div class="flex-wrap card-header d-flex justify-content-between">
                    <div class="header-title">
                       <h4 class="mb-2 card-title">Result Summary</h4>
                       <p class="mb-0">
                          <svg class="me-1 text-primary icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          {{ $countResults }} pengerjaan di minggu ini, dari <strong>{{\Carbon\Carbon::parse($formattedStartOfWeek)->format('Y-m-d') }}</strong> hingga <strong>{{ \Carbon\Carbon::parse($formattedEndOfWeek)->format('Y-m-d')}}</strong>
                       </p>
                    </div>
                 </div>
                 <div class="p-0 card-body">
           ...
           <div class="col-md-12 col-lg-12">
              <div class="card" data-aos="fade-up" data-aos-delay="500">
                 <div class="text-center card-body d-flex justify-content-around">
                  ...
                  {{-- Total Result  --}}
                    @if ($totalResult >= 1000000)
                    <h2 class="mb-2">{{ (int)$totalResult / 1000000 }} K</h2>
                    @elseif ($totalResult >= 1000)
                    <h2 class="mb-2">{{ (int)$totalResult / 1000 }} K</h2>
                    @else
                    <h2 class="mb-2">{{ $totalResult }}</h2>
                    @endif
                    ...
                    <div>
                     {{-- Total Result  --}}
                    @if ($totalUser >= 1000000)
                    <h2 class="mb-2">{{ (int)$totalUser / 1000000 }} K</h2>
                    @elseif ($totalUser >= 1000)
                    <h2 class="mb-2">{{ (int)$totalUser / 1000 }} K</h2>
                    @else
                    <h2 class="mb-2">{{ $totalUser }}</h2>
                    @endif
                       <p class="mb-0 text-gray">Total Peserta</p>
