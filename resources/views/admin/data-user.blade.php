                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="header-title d-flex align-items-center justify-content-between">
                                    ...
                                    <a class="btn btn-border ps-4" href="{{ route('team.create') }}">
                                        Add New
                                            ...
                                            @foreach ($userList as $user)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            ...
                                                            <div class="skeleton-box"
                                                                style="width: 100px; height: 20px; background-color: #f0f0f0;">
                                                            </div>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        ...
                                                        @else
                                                            <!-- Handle other roles or set a default badge color -->
                                                            <span class="badge bg-secondary">{{ $user->role }}</span>
                                                        @endif
                                                    </td>

                                                    @if ($user->created_at)
                                                        <td>{{ \Carbon\Carbon::parse($user->created_at)->format('Y/m/d') }}
                                                        </td>
                                                    @else
                                                    ...
                                                    <td>
                                                        @if ($user->role !== 'super admin')
                                                            <div class="flex align-items-center list-user-action">
                                                                <a class="btn btn-sm btn-icon btn-warning"
                                                                    ...
                                                                    title="Edit"
                                                                    href="{{ route('team.edit', $user->user_id) }}">
                                                                ...
                                                                <a class="btn btn-sm btn-icon btn-danger"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Delete"
                                                                    href="{{ route('team.destroy', $user->user_id) }}"
                                                        ...
                                                        @else
                                                            <!-- Hide or disable buttons for super admin -->
                                                            <div class="flex align-items-center list-user-action">
                                                                <button class="btn btn-sm btn-icon btn-warning" disabled>
                                                                    <span class="btn-inner">
                                                                        <svg class="icon-20" width="20"
                                                                            viewBox="0 0 24 24" fill="none"
                                                                            xmlns="http://www.w3.org/2000/svg">
